				...
				<div className="lg:w-1/2 xl:max-w-screen-sm">
					<div className="py-12  flex justify-center lg:justify-start lg:px-12">
						<div className="cursor-pointer flex items-center">
							...
							<div className="text-2xl text-primary tracking-wide ml-2 font-semibold">
								Bermuda Triangle Aquatics Admin Login
							</div>
						</div>
					</div>
                    ...
                    xl:text-bold"
						...
						<div className="mt-12">
							<form>
								{/* <div>
                                    <div className="text-sm font-bold text-primary">Email Address</div>
                                    <input className="input input-primary w-full" type="" placeholder="admin@bermuda-triangle-aquatics.com" />
                                </div>
                                <div className="mt-8">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <div>
                                            <a className="text-xs font-display font-semibold text-primary hover:text-primary-focus cursor-pointer">
                                                Forgot Password?
                                            </a>
                                        </div>
                                    </div>
                                    <input className="input input-primary w-full" type="" placeholder="Enter your password" />
                                </div>
                                <div className="mt-10">
								...
								<div className="mt-10">
									...
									>
										<div className="rounded bg-opacity-10 mr-5">
											<FcGoogle size={40} />
										</div>
										Sign in with Google
									</button>
							...
							{/* <div className="mt-12 text-sm font-display font-semibold  text-center">
                                Don't have an account ? <a className="cursor-pointer text-secondary hover:text-secondary-focus">Sign up</a>
                            </div> */}
						</div>
					</div>
				</div>
